...
local function addState(self, params)
    ...
    state["onFrameCollisionEvent"] = params
        .onFrameCollisionEvent                                -- Event that will be raised when animation moves to the next frame
    state["onFrameSfxEvent"] = params
        .onFrameSfxEvent                                      -- Event that will be raised when animation moves to the next frame
